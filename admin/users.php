		...
		$form = <<<HTML
			<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
				...
				<div class="form-control">
					...
					<input type="email" placeholder="Enter the User Email" class="form-input" name="user-email" id="user-email" value="{$user->email}">
				</div>
				<div class="form-control">
					<label class="form-label" for="user-classes">Classes</label>
					<input type="text" placeholder="Enter the User Classes" class="form-input" name="user-classes" id="user-classes" value="{$classes}">
				</div>
				<div class="form-control">
