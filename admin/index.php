<?php 
			...
			<div class="card soft">
				<div class="display-flex">
					<div class="flex-none images-thumb">
						<img src="../outline/img/$o->thumbnail">
					</div>
	...
	function showProductPage($o){
		...
		$images = array_reduce(explode(",", $o->images), function($r, $o){return $r."<img src='../outline/img/$o'>";});
		...
		$display = <<<HTML
			<div>
				...
				<div class="form-control">
					...
					<span class="images-thumb"><img src='../outline/img/$o->thumbnail'></span>
				</div>
				<div class="form-control">
